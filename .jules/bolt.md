...
## 2023-11-09 - [Reduce Render Allocations]
**Learning:** Re-allocating static arrays (like priority lists) or defining objects inside a React component's render function forces unnecessary memory re-allocation on every render.
**Action:** Always hoist static constant arrays or objects outside the React component to the module scope to improve rendering performance and reduce garbage collection overhead.
