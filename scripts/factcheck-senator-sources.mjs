...
const MAP = [
  ...
  // --- refinamento das 25 restantes (substrings exatas do conteúdo) ---
  ...
  { match: 'Luciano Schafer, conhecido como Luciano do MLB', url: 'https://divulgacandcontas.tse.jus.br/divulga/#/candidato/SUL/RS/2045202024/210001945445/2024/88013', text: 'TSE DivulgaCand — Luciano do MLB (UP) Senado RS' },
  { match: 'Luciano Schafer disputa o Senado Federal', url: 'https://divulgacandcontas.tse.jus.br/divulga/#/candidato/SUL/RS/2045202024/210001945445/2024/88013', text: 'TSE DivulgaCand — Luciano do MLB (UP) Senado RS' },
  ...
  { match: 'Milton Batista Cardoso disputa', url: 'https://www.correiodopovo.com.br/not%C3%ADcias/pol%C3%ADtica/elei%C3%A7%C3%B5es/eleicoes-2026-saiba-quem-e-milton-cardoso-psdb-1.1728006', text: 'Correio do Povo — Milton Cardoso (PSDB) Senado RS 2026' },
  { match: 'Paulo Renato Jaguarão Silva da Rosa disputa', url: 'https://www.plural.jor.br/paulo-renato-jaguarao-silva-da-rosa/', text: 'Plural — Paulo Renato Jaguarão (Cidadania) Senado RS 2026' },
  ...
  { match: 'Marcel van Hattem disputa', url: 'https://www.camara.leg.br/deputados/156190', text: 'Câmara dos Deputados — Marcel van Hattem (NOVO) Senado RS' },
  ...
  { match: 'Paulo Pimenta é deputado federal pelo PT', url: 'https://pt.org.br/paulo-pimenta/', text: 'PT — perfil oficial Paulo Pimenta' },
  { match: 'Reconstrução do RS com Paulo Pimenta', url: 'https://pt.org.br/paulo-pimenta/', text: 'PT — Paulo Pimenta (Senado RS 2026)' },
  { match: 'Tânia Peres é candidata ao Senado pela UP', url: 'https://www.jota.info/eleicoes/eleicoes-2026/quem-sao-os-pre-candidatos-ao-senado-pelo-rio-grande-do-sul-rs-nas-eleicoes-de-2026', text: 'JOTA — pré-candidatos Senado RS (Tânia Peres/UP)' },
];
