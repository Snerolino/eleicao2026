...
describe('snapshot público de candidatos', () => {
  ...
  it('mantém fotos oficiais rastreáveis e com asset público existente', () => {
    ...
    for (const candidate of withPhotos) {
      const is2026 = candidate.photo_url.startsWith('/photos/tse-2026-rs/');
      const is2024 = candidate.photo_url.startsWith('/photos/tse-2024-rs/');
      expect(is2026 || is2024).toBe(true);
      if (is2026) {
