---
name: eleicao2026-claims-enrichment
type: skill
description: "Use when enriching claims para candidatos eleitorais RS 2026 via AGY em blocos de 25. Pipeline completo: gerar prompt → executar AGY → importar no Supabase."
---
...
Estado atual (2026-08-15): **blocos 0–4 completos e importados** (171 claims `pending_review` para 125 candidatos). Blocos 5–40 em execução paralela via batch.
...
### Bloco com output corrompido (exit=46)

O bloco 1 teve exit=46 na primeira tentativa (output corrompido — 939 bytes com erro AGY). Reprocesso com nova chave resolveu.
