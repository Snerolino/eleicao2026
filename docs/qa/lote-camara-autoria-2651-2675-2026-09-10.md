...
- Commit funcional publicado: `d9d197aff7fadc6a212f4afd66c40fc0be2ed59e`; `git ls-remote` confirmou `main` alinhada naquele momento.
- Workflow backup `334951434`, run `34549674612`, terminou `completed/success` com `headSha` exato do commit funcional.
...
- A documentação de verificação posterior foi publicada no commit `f232143cd6290d7bc928f131e24a5f235184fce6`; o dispatch manual `34549787190` para esse commit terminou `skipped` (workflow remoto sem job executável para esse evento). A produção permanece no commit funcional anterior `d9d197a`; não foi mascarada como deploy do commit documental.
