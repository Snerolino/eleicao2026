# QA — Reconhecimento oficial bounded Senado/ALRS/Câmara (2026-08-20 20:45 UTC)
...
## Gates locais
- Doctor do cron: exit 1 por shell Node 22.22.2; rota Node 24 usada nos gates.
...
- `npm run build`: exit 0; sitemap com 1.003 candidatos + 2 estáticas; release local gerado.
...
## Artefatos read-only
- `.orchestrator/runtime/continuous-tick-20260820T2045Z/senado.json`
- `.orchestrator/runtime/continuous-tick-20260820T2045Z/alrs.html`
- `.orchestrator/runtime/continuous-tick-20260820T2045Z/alrs.json`
