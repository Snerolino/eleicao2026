...
- Commit documental do lote: `9c8a93c7c0494d177d949268ac1f49dff03b957e`, publicado em `origin/main`.
- Backup Cloudflare `334951434`, run `32348781252`: `completed/success`, `headSha` idêntico ao commit.
- Produção `https://rs.votopraquem.org/`: raiz e `/release.json` HTTP 200.
- `release.json` confirmou `release_id=9c8a93c-20260820T082633676Z`, `sha` completo idêntico, versão `0.2.519` e snapshot `row_count=1003`.
