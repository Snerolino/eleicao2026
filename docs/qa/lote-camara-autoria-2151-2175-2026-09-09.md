...
- Commit publicado: 8276d0a09988b71f66baed251d45d1eb5c23cfc7; origin/main alinhado.
- Backup Cloudflare workflow 334951434: run 34429161211, completed/success, headSha exato.
- Produção com User-Agent: raiz HTTP 200; release.json HTTP 200, release 8276d0a-20260910T022246153Z, SHA exato e snapshot row_count=1003. A requisição sem User-Agent retornou HTTP 403 neste ambiente; a verificação repetida com User-Agent confirmou a publicação.
