...
- Commit publicado: c09b97bfbdd7c0bca546bcb904033f29442e2f8f; origin/main alinhado.
- Backup Cloudflare workflow 334951434: run 34429009128, completed/success, headSha exato.
- Produção com User-Agent: raiz HTTP 200; release.json HTTP 200, release c09b97b-20260910T022039823Z, SHA exato e snapshot row_count=1003. A requisição sem User-Agent retornou HTTP 403 neste ambiente; a verificação repetida com User-Agent confirmou a publicação.
