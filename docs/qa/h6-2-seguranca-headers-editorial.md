...
- `script-src 'self' 'unsafe-inline' https://static.cloudflareinsights.com` para compatibilidade com scripts inline dinâmicos injetados pelo Cloudflare Web Analytics no domínio de produção
