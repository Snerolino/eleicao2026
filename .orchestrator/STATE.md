...
- Commits documentais `a2f9dcd69f5470927c87ccebe079478d621be86a` e `7546d7d9fc08e6a98021270f039c0f16f7b1221f` publicados; backup `334951434`, run `32410183487`, `completed/success`, `headSha` final idêntico; produção raiz e `/release.json` HTTP 200 alinhados ao SHA final, snapshot `row_count=1003`; smoke remoto exit 0 (1002 cards, 0 falhas HTTP, 0 erros de console).
