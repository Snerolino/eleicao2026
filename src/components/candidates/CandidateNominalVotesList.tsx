  ...
  return (
    <div className="mt-6 border border-[var(--color-border-editorial)] bg-[var(--color-paper)]">
      ...
      <button
        ...
        className="w-full p-5 text-left flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between hover:bg-[var(--color-surface-hover,rgba(0,0,0,0.02))] transition-colors cursor-pointer"
      >
        <div>
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto font-mono text-xs font-semibold text-[var(--color-institutional)]">
          <span>{isExpanded ? "Ocultar votações" : "Ver registro detalhado"}</span>
          <span
            aria-hidden="true"
          ...
          <div className="pt-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-1.5 font-mono text-xs">
              <button
                ...
                className={`px-2.5 py-1 transition-colors border cursor-pointer ${
                  filterValue === "all"
