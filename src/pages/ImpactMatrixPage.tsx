                    ...
                    <div className="mt-3 pt-3 border-t border-gray-600">
                      ...
                      <ol className="list-decimal list-inside text-xs text-gray-300">
                        {assessment.sources.map((src, i) => {
                          ...
                          return <li key={i} className="break-all">{safeUrl ? <a href={safeUrl} target="_blank" rel="noopener noreferrer" className="underline text-blue-400">Fonte {i + 1}</a> : <span className="text-gray-500">Fonte {i + 1} (link inválido)</span>}</li>;
                        })}
                      </ol>
                    </div>
                  )}
