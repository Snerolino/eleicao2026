                  ...
                  <Fragment key={item.proposition_version_id}>
                    ...
                    <div className="mt-3 flex flex-wrap gap-3 font-mono text-xs uppercase tracking-wider">
                      {sanitizeUrl(item.proposition_page) && (
                        <a href={sanitizeUrl(item.proposition_page)} target="_blank" rel="noreferrer" className="text-[var(--color-institutional)] underline-offset-4 hover:underline">
                          Fonte da proposição
                        </a>
                      )}
                      {item.source_urls.slice(0, 2).map((sourceUrl) => {
                        ...
                        return safeUrl ? (
                          <a key={sourceUrl} href={safeUrl} target="_blank" rel="noreferrer" className="text-[var(--color-institutional)] underline-offset-4 hover:underline">
                            Fonte do voto
                          </a>
                        ) : null;
                      })}
